        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon) => (
              <div
                key={icon.src}
                className="flex bg-white justify-center items-center w-12 h-12 rounded-full"
              >
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className="text-base mt-3 leading-normal font-montserrat text-white-400 hover:text-slate-gray cursor-pointer"
                    key={link.name}
                  >
                    <a>{link.name}</a>
                  </li>
